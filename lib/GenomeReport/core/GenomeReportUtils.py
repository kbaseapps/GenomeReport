...
class GenomeReportUtils:
    ...
    def _generate_genome_html(self, out_dir, genome_ref):
        ...
        js_content3 = self._write_genome_js('./js/bar_chart_anim.js', dataset=dataset)
        ...
        footer_content = ''
        with open(os.path.join(os.path.dirname(__file__), './html/citations.html'), 'r') as footer_file:
        ...
        with open(report_file_path, 'w') as report_file:
            with open(os.path.join(os.path.dirname(__file__), './html/genome_report_template.html'),
